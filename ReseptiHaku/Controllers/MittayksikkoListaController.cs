...
namespace ReseptiHaku.Controllers
{
    public class MittayksikkoListaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MittayksikkoID,Mittayksikko")] MittayksikkoLista mittayksikkoLista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MittayksikkoID,Mittayksikko")] MittayksikkoLista mittayksikkoLista)
        {
            if (ModelState.IsValid)
            {
